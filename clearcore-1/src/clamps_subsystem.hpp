...
#define CLAMPS_DEFAULT_PRE_CUT_CLAMPING_OFFSET    30000     //was 40000, moving to close more after clamping stops, this plus the clamp pos should not be more than squish
