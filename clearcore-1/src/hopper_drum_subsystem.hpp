...
#define DRUM_MOVE_CLEAR_SENSOR_TIME_MS 800
#define DRUM_CLEAR_SENSOR_TIME_MS 400
#define DRUM_INIT_CLEAR_SENSOR_TIME_MS 600
#define DRUM_INIT__DUMP_CLEAR_SENSOR_TIME_MS 1000
