...
#define DB_GUTTER_MAX_MOVE_DEFAULT 5000
#define DB_GUTTER_TIMEOUT_MS_DEFAULT 5000
#define DB_GUTTER_MOT_SPEED_DEFAULT 10000
#define DB_GUTTER_MOT_ACCEL_DEFAULT 20000

#define DB_TURNT_MOT_SPEED_DEFAULT 10000
#define DB_TURNT_MOT_ACCEL_DEFAULT 20000
...
static ModbusRegister cc2_modbus[CC2_NUM_MODBUS_REGISTERS] =
{
    ...
    {HOLDING_REG, DB_TURNT_MOVE_STEPS, 1000, nullptr}
